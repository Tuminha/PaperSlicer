...
def test_added_review_and_clinical_synonyms():
    ...
    assert canonical_section_name("Evaluation of Volume Loss") == "materials_and_methods"
    assert canonical_section_name("Scanning") == "materials_and_methods"
    assert canonical_section_name("Drink Selection") == "materials_and_methods"
    assert canonical_section_name("Microscope positioning and use") == "materials_and_methods"
    assert canonical_section_name("Flap incision and elevation") == "materials_and_methods"
    assert canonical_section_name("Root apex positioning") == "materials_and_methods"
    assert canonical_section_name("Root end resection, curettage, and inspection") == "materials_and_methods"
    assert canonical_section_name("Suturing") == "materials_and_methods"
    assert canonical_section_name("Suture removal") == "materials_and_methods"
